...
{
    public class MongoDbCoinExDbSchemaMigrator : ICoinExDbSchemaMigrator , ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public MongoDbCoinExDbSchemaMigrator(IServiceProvider serviceProvider)
        {
